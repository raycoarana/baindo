...
/**
 * Binds/unbind a Command to a view's OnLongClickListener event.
 */
public class LongClickToCommandBind extends BaseBind<Void, Command> {

    public LongClickToCommandBind(BindableSource bindableSource, WorkDispatcher workDispatcher) {
